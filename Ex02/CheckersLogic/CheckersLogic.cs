...
namespace Ex02
{
    public class CheckersLogic
    {
        ...
        public bool MakeComputerMove(out string o_ChosenMove)
        {
            o_ChosenMove = string.Empty;
            ...
            else
            {
                ...
                moveSucceeded = MakeMove(chosenMove, out string errorMsg);

                if (moveSucceeded)
                {
                    o_ChosenMove = chosenMove.ToString();
                }
                else
                {
                    o_ChosenMove = $"Computer move failed: {errorMsg}";
                }
            }
        ...
        private List<Move> getAllPossibleMovesForPlayer(Player i_Player)
        {
